...
monaco.editor.defineTheme('dev-tools-dark', {
  base: 'vs-dark',
  inherit: true,
  rules: [],
  colors: {
...
monaco.editor.defineTheme('dev-tools-light', {
  base: 'vs',
  inherit: true,
  rules: [],
  colors: {
...
watch(
  ...
  isDarkTheme => monaco.editor.setTheme(isDarkTheme ? 'dev-tools-dark' : 'dev-tools-light'),
  { immediate: true },
);
